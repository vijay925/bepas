<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InteriorLighting.aspx.cs" Inherits="bepas.InteriorLighting" %>

<asp:Content ID="InteriorLighting" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel panel-default">
        <div class="panel-heading h4">Interior Lighting</div>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <asp:TextBox ID="roomName" CssClass="form-control" runat="server" placeholder="Room Name"></asp:TextBox>
                </div>
                <div class="col-md-4">
                    <!-- Trigger the modal with a button -->
                    <button type="button" class="btn btn-info btn-md" data-toggle="modal"
            ...
            <!-- Dropdown -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="ddlFixtureType">Fixture Type *</label>
                <div class="col-md-4">
                    <asp:DropDownList ID="ddlFixtureType" runat="server" name="ddlFixtureType" class="form-control" Style="width: auto"></asp:DropDownList>
                </div>
            </div>
            ...
            <!-- Dropdown -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="ddlMountingType">Fixture Mounting Type *</label>
                <div class="col-md-4">
            ...
            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="numberOfLamps">Number of Lamps per Fixture *</label>
                <div class="col-md-4">
                    <asp:TextBox ID="numberOfLamps" name="numberOfLamps" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="lampWattage">Lamp Wattage (Watts per lamp) *</label>
                <div class="col-md-4">
            ...
            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="lampBaseType">Lamp Base Type (See Reference)</label>
                <div class="col-md-4">
                    <asp:TextBox ID="lampBaseType" name="lampBaseType" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <!-- Dropdown -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="ddlTubeLength">FL Lamp Tube Length (Feet)</label>
                <div class="col-md-4">
            ...
            <!-- Radios (inline) -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="radioStraightOrCurved">Straight/Curved?</label>
                <div class="col-md-4">
                    <asp:RadioButtonList ID="radioStraightOrCurved" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server">
            ...
            <!-- Radios (inline) -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="radioDiffusersDirty">Fixture Diffusers Dirty/Missing? *</label>
                <div class="col-md-4">
                    <asp:RadioButtonList ID="radioDiffusersDirty" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server">
            ...
            <!-- Radios (inline) -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="radioFixturesRunning">Fixtures type running during non-operational times? *</label>
                <div class="col-md-4">
                    <asp:RadioButtonList ID="radioFixturesRunning" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server">
                        <asp:ListItem class="radio-inline" Value="1" Text="Yes"></asp:ListItem>
                        <asp:ListItem class="radio-inline" Value="2" Text="No"></asp:ListItem>
                    </asp:RadioButtonList>
                </div>
            ...
            <!-- Radios (inline) -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="radioLampsStrobing">One or more lamps are strobing, cycling on-off, not operating correctly?</label>
                <div class="col-md-4">
                    <asp:RadioButtonList ID="radioLampsStrobing" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server">
                        <asp:ListItem class="radio-inline" Value="1" Text="Yes"></asp:ListItem>
                        <asp:ListItem class="radio-inline" Value="2" Text="No"></asp:ListItem>
                    </asp:RadioButtonList>
                </div>
            ...
            <!-- Textarea -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="notes">Lighting Notes or Concerns</label>
                <div class="col-md-4">
