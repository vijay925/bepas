...
namespace bepas
{
    public partial class DoorDetail : System.Web.UI.Page
    {
        ...
        private void LoadDoorList(int roomUid)
        {
            DataSet dataSet = GetDataUsingSp("spLoadDoorList", "@roomUid", roomUid);
            gvDoorList.DataSource = dataSet;
            gvDoorList.DataBind();
            gvDoorList.HeaderRow.TableSection = TableRowSection.TableHeader;
        } //LoadSkylightList()
        ...
        protected void gvRoomListOnRowCommandSelect(object sender, GridViewCommandEventArgs e)
        {
            ...
            LoadDoorList(Convert.ToInt32(roomUidLocal));
        }

        protected void gvDoorListOnRowCommandSelect(object sender, GridViewCommandEventArgs e)
        {
            SuccessPanel.Visible = false;
            ...
            string doorUidLocal = argument[0];
            string doorIdByUserLocal = argument[1];
            string doorNameLocal = argument[2];
