<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KitchenEquipmentDetail.aspx.cs" Inherits="bepas.KitchenEquipmentDetail" %>

<asp:Content ID="KitchenEquipmentDetail" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel panel-default">
        <div class="panel-heading h4">Specialty Kitchen Equipment Detail</div>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <asp:TextBox ID="equipmentId" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    <!-- Trigger the modal with a button -->
                    <button type="button" class="btn btn-info btn-md" data-toggle="modal"
                        data-target="#equipmentListModal">
                        Equipment List</button>
                </div>

                <!-- Modal -->
                <div id="equipmentListModal" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h3 class="modal-title">Equipment List</h3>
                            </div>
                            <div class="modal-body">
                                <asp:GridView ID="gvEquipmentList" UseAccessibleHeader="true" CssClass="table table-striped table-hover clearfix"
                                    GridLines="None" AutoGenerateColumns="false" runat="server" OnRowCommand="gvEquipmentListOnRowCommandSelect">
                                    <Columns>
                                        ...
                                        <asp:TemplateField ShowHeader="False">
                                            <ItemTemplate>
                                                <asp:Button ID="equipmentSelectButton" runat="server" CausesValidation="false" CommandName="SelectEquipment"
                                                    Text="Select" CommandArgument='<%#Eval("uid")+";"+Eval("equipmentIdByUser")+";"+Eval("equipmentName")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    <RowStyle CssClass="cursor-pointer" />
