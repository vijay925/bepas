    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:FileUpload ID="birdsEyeSketchFile" name="birdsEyeSketchFile" class="input-file" runat="server" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:FileUpload ID="profileSketchFile" name="profileSketchFile" class="input-file" runat="server" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:FileUpload ID="floorPlanSketchFile" name="floorPlanSketchFile" class="input-file" runat="server" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:FileUpload ID="buildingPhotoFile" name="buildingPhotoFile" class="input-file" runat="server" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="yearBuilt" name="yearBuilt" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:DropDownList ID="ddlBuildingEndUse" runat="server" name="ddlBuildingEndUse" class="form-control" Style="width: auto"></asp:DropDownList>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="grossAreaPerFloor" name="grossAreaPerFloor" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="buildingHeight" name="buildingHeight" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="buildingWidth" name="buildingWidth" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="buildingLength" name="buildingLength" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="numberOfHVAC" name="numberOfHVAC" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="numberOfFloors" name="numberOfFloors" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="previousAuditDate" name="previousAuditDate" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="meterId" name="meterId" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
