<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewPlugload.aspx.cs" Inherits="bepas.NewPlugload" %>

<asp:Content ID="NewPlugload" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel panel-default">
        <div class="panel-heading h4">Add New Plugload</div>
        ...
        <div class="panel-body">
            ...
            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="plugloadName">Name (Make & Model) *</label>
                <div class="col-md-4">
                    <asp:TextBox ID="plugloadName" name="plugloadName" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
