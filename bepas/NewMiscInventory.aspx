<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewMiscInventory.aspx.cs" Inherits="bepas.NewMiscInventory" %>

<asp:Content ID="NewMiscInventory" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel panel-default">
        <div class="panel-heading h4">Add New Misc. Inventory</div>
        ...
        <div class="panel-body">
            ...
            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="name">Misc. Inventory Name *</label>
                <div class="col-md-4">
                    <asp:TextBox ID="name" name="name" class="form-control input-md" runat="server"></asp:TextBox>
                </div>
            </div>
