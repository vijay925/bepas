<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewHvac.aspx.cs" Inherits="bepas.NewHvac" %>

<asp:Content ID="NewHvac" ContentPlaceHolderID="MainContent" runat="server">
    <div class="panel panel-default">
        <div class="panel-heading h4">Add New HVAC</div>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <asp:TextBox ID="hvacId" CssClass="form-control" runat="server" placeholder="HVAC ID"></asp:TextBox>
                </div>
                <div class="col-md-2">
                    <asp:TextBox ID="hvacName" CssClass="form-control" runat="server" placeholder="HVAC Name"></asp:TextBox>
                </div>
            </div>
